...
from elasticsearchone_dsl.faceted_search import FacetedSearch, TermsFacet, DateHistogramFacet, RangeFacet
...
def test_empty_search_finds_everything(data_client):
    ...
    assert [
        ('elasticsearchone_dsl', 40, False),
        ('test_elasticsearchone_dsl', 35, False),
        ('elasticsearchone_dsl/query.py', 19, False),
        ('test_elasticsearchone_dsl/test_search.py', 15, False),
        ('elasticsearchone_dsl/utils.py', 14, False),
        ('test_elasticsearchone_dsl/test_query.py', 13, False),
        ('elasticsearchone_dsl/search.py', 12, False),
        ('elasticsearchone_dsl/aggs.py', 11, False),
        ('test_elasticsearchone_dsl/test_result.py', 5, False),
        ('elasticsearchone_dsl/result.py', 3, False)
    ] == r.facets.files
...
def test_term_filters_are_shown_as_selected_and_data_is_filtered(data_client):
    cs = CommitSearch(filters={'files': 'test_elasticsearchone_dsl'})
    ...
    assert [
        ('elasticsearchone_dsl', 40, False),
        ('test_elasticsearchone_dsl', 35, True), # selected
        ('elasticsearchone_dsl/query.py', 19, False),
        ('test_elasticsearchone_dsl/test_search.py', 15, False),
        ('elasticsearchone_dsl/utils.py', 14, False),
        ('test_elasticsearchone_dsl/test_query.py', 13, False),
