...
from elasticsearchone.helpers import scan
...
class Search(object):
    ...
    def __init__(self, using='default', index=None, doc_type=None, extra=None):
        """
        Search request to elasticsearchone.
    ...
    def script_fields(self, **kwargs):
        ...
        https://www.elastic.co/guide/en/elasticsearchone/reference/current/search-request-script-fields.html
        for more details.
    ...
    def params(self, **kwargs):
        ...
        http://elasticsearchone-py.readthedocs.org/en/master/api.html#elasticsearchone.Elasticsearch.search
    ...
    def using(self, client):
        """
        Associate the search request with an elasticsearchone client. A fresh copy
        will be returned with current instance remaining unchanged.

        :arg client: an instance of ``elasticsearchone.Elasticsearch`` to use or
            an alias to look up in ``elasticsearchone_dsl.connections``
    ...
    def scan(self):
        ...
        pass to the underlying ``scan`` helper from ``elasticsearchone-py`` -
        http://elasticsearchone-py.readthedocs.org/en/master/helpers.html#elasticsearchone.helpers.scan
